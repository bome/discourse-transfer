...
{
    public static final String ACTIVATE_USER_ENDPOINT = "/admin/users/%s/activate.json";
     ...
     * @throws Exception
     */
    public int activate(int userId) throws Exception
    {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPut httpPut = HttpPutHelper.createHttpPut(String.format(ACTIVATE_USER_ENDPOINT,userId));

        HttpResponse response = httpClient.execute(httpPut);
        int code = response.getStatusLine().getStatusCode();
        DiscourseTransfer.log.config("REQUEST:"+String.format(ACTIVATE_USER_ENDPOINT,userId));
